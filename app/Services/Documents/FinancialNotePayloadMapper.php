...
class FinancialNotePayloadMapper
{
    ...
    public function mapDebitNote(DebitNote $debitNote): array
    {
        ...
        return [
            ...
            'policy_number' => $debitNote->policy ? $debitNote->policy->policy_number_display : 'To Be Advised',
    ...
    public function mapCreditNote(CreditNote $creditNote): array
    {
        ...
        return [
            ...
            'policy_number' => $creditNote->policy ? $creditNote->policy->policy_number_display : 'To Be Advised',
            'policy_type' => $policyType,
            'class_of_business' => $classOfBusiness,
