...
export const policies = (
    args: { customer: string | number } | [customer: string | number] | string | number,
...
policies.url = (args: { customer: string | number } | [customer: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return policies.definition.url.replace('{customer}', parsedArgs.customer.toString()).replace(/\/+$/, '') + queryParams(options);
};
