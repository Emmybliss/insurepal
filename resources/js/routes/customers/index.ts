 ...
 */
export const show = (
    args: { customer: number | { id: number } } | [customer: number | { id: number }] | number | { id: number },
...
show.url = (
    ...
    return show.definition.url.replace('{customer}', parsedArgs.customer.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
edit.url = (
    ...
    return edit.definition.url.replace('{customer}', parsedArgs.customer.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
update.url = (
    ...
    return update.definition.url.replace('{customer}', parsedArgs.customer.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
destroy.url = (
    ...
    return destroy.definition.url.replace('{customer}', parsedArgs.customer.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
provisionAccess.url = (
    ...
    return provisionAccess.definition.url.replace('{customer}', parsedArgs.customer.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
revokeAccess.url = (
    ...
    return revokeAccess.definition.url.replace('{customer}', parsedArgs.customer.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
resetPassword.url = (
    ...
    return resetPassword.definition.url.replace('{customer}', parsedArgs.customer.toString()).replace(/\/+$/, '') + queryParams(options);
};
