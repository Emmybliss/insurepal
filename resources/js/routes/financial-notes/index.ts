 ...
 */
export const show = (
    args: { financial_note: string | number } | [financial_note: string | number] | string | number,
...
show.url = (args: { financial_note: string | number } | [financial_note: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return show.definition.url.replace('{financial_note}', parsedArgs.financial_note.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
edit.url = (args: { financial_note: string | number } | [financial_note: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return edit.definition.url.replace('{financial_note}', parsedArgs.financial_note.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
update.url = (args: { financial_note: string | number } | [financial_note: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return update.definition.url.replace('{financial_note}', parsedArgs.financial_note.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
destroy.url = (args: { financial_note: string | number } | [financial_note: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return destroy.definition.url.replace('{financial_note}', parsedArgs.financial_note.toString()).replace(/\/+$/, '') + queryParams(options);
};
 ...
 */
export const issue = (
    args: { financialNote: number | { id: number } } | [financialNote: number | { id: number }] | number | { id: number },
    options?: RouteQueryOptions,
...
issue.url = (
    ...
    const parsedArgs = {
        financialNote: typeof args.financialNote === 'object' ? args.financialNote.id : args.financialNote,
    };

    return issue.definition.url.replace('{financialNote}', parsedArgs.financialNote.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
markPaid.url = (
    ...
    return markPaid.definition.url.replace('{financialNote}', parsedArgs.financialNote.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
cancel.url = (
    ...
    return cancel.definition.url.replace('{financialNote}', parsedArgs.financialNote.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
download.url = (
    ...
    return download.definition.url.replace('{financialNote}', parsedArgs.financialNote.toString()).replace(/\/+$/, '') + queryParams(options);
};
