 ...
 */
export const show = (
    args: { quote: number | { id: number } } | [quote: number | { id: number }] | number | { id: number },
...
show.url = (args: { quote: number | { id: number } } | [quote: number | { id: number }] | number | { id: number }, options?: RouteQueryOptions) => {
    ...
    return show.definition.url.replace('{quote}', parsedArgs.quote.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
edit.url = (args: { quote: number | { id: number } } | [quote: number | { id: number }] | number | { id: number }, options?: RouteQueryOptions) => {
    ...
    return edit.definition.url.replace('{quote}', parsedArgs.quote.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
update.url = (args: { quote: number | { id: number } } | [quote: number | { id: number }] | number | { id: number }, options?: RouteQueryOptions) => {
    ...
    return update.definition.url.replace('{quote}', parsedArgs.quote.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
destroy.url = (
    ...
    return destroy.definition.url.replace('{quote}', parsedArgs.quote.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
send.url = (args: { quote: number | { id: number } } | [quote: number | { id: number }] | number | { id: number }, options?: RouteQueryOptions) => {
    ...
    return send.definition.url.replace('{quote}', parsedArgs.quote.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
accept.url = (args: { quote: number | { id: number } } | [quote: number | { id: number }] | number | { id: number }, options?: RouteQueryOptions) => {
    ...
    return accept.definition.url.replace('{quote}', parsedArgs.quote.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
reject.url = (args: { quote: number | { id: number } } | [quote: number | { id: number }] | number | { id: number }, options?: RouteQueryOptions) => {
    ...
    return reject.definition.url.replace('{quote}', parsedArgs.quote.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
convertToPolicy.url = (
    ...
    return convertToPolicy.definition.url.replace('{quote}', parsedArgs.quote.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
duplicate.url = (
    ...
    return duplicate.definition.url.replace('{quote}', parsedArgs.quote.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
extendValidity.url = (
    ...
    return extendValidity.definition.url.replace('{quote}', parsedArgs.quote.toString()).replace(/\/+$/, '') + queryParams(options);
};
