 ...
 */
export const show = (
    args: { message: number | { id: number } } | [message: number | { id: number }] | number | { id: number },
...
show.url = (
    ...
    const parsedArgs = {
        message: typeof args.message === 'object' ? args.message.id : args.message,
    };

    return show.definition.url.replace('{message}', parsedArgs.message.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
edit.url = (
    ...
    return edit.definition.url.replace('{message}', parsedArgs.message.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
update.url = (
    ...
    return update.definition.url.replace('{message}', parsedArgs.message.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
destroy.url = (
    ...
    return destroy.definition.url.replace('{message}', parsedArgs.message.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
export const downloadAttachment = (
    args: { message: number | { id: number }; index: string | number } | [message: number | { id: number }, index: string | number],
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
...
downloadAttachment.url = (
    ...
    return (
        downloadAttachment.definition.url
