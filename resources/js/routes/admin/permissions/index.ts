 ...
 */
export const edit = (
    args: { permission: string | number } | [permission: string | number] | string | number,
...
edit.url = (args: { permission: string | number } | [permission: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return edit.definition.url.replace('{permission}', parsedArgs.permission.toString()).replace(/\/+$/, '') + queryParams(options);
};
