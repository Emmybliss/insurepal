 ...
 */
export const show = (
    args: { policy: number | { id: number } } | [policy: number | { id: number }] | number | { id: number },
...
show.url = (args: { policy: number | { id: number } } | [policy: number | { id: number }] | number | { id: number }, options?: RouteQueryOptions) => {
    ...
    const parsedArgs = {
        policy: typeof args.policy === 'object' ? args.policy.id : args.policy,
    };

    return show.definition.url.replace('{policy}', parsedArgs.policy.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
edit.url = (args: { policy: number | { id: number } } | [policy: number | { id: number }] | number | { id: number }, options?: RouteQueryOptions) => {
    ...
    return edit.definition.url.replace('{policy}', parsedArgs.policy.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
update.url = (
    ...
    return update.definition.url.replace('{policy}', parsedArgs.policy.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
destroy.url = (
    ...
    return destroy.definition.url.replace('{policy}', parsedArgs.policy.toString()).replace(/\/+$/, '') + queryParams(options);
};
 ...
 */
export const renew = (
    args: { policy: string | number } | [policy: string | number] | string | number,
    options?: RouteQueryOptions,
...
renew.url = (args: { policy: string | number } | [policy: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return renew.definition.url.replace('{policy}', parsedArgs.policy.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
cancel.url = (args: { policy: string | number } | [policy: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return cancel.definition.url.replace('{policy}', parsedArgs.policy.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
download.url = (args: { policy: string | number } | [policy: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return download.definition.url.replace('{policy}', parsedArgs.policy.toString()).replace(/\/+$/, '') + queryParams(options);
};
