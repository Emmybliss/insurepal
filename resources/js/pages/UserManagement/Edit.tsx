...
import { Check, Eye, EyeOff, Lock, Save, User, X } from 'lucide-react';
        ...
        put(route('user-management.update', user.id), {
            ...
            onSuccess: () => {
                toast.success('User updated successfully', {
                    id: 'update-user',
                    description: 'All user information has been saved',
                    duration: 4000,
                });
            },
            onError: () => {
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Configure user status and access</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                        ...
                        <CardContent className="space-y-4">
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">{user.email_verified_at ? 'Yes' : 'No'}</p>
                                </div>
                                <div>
