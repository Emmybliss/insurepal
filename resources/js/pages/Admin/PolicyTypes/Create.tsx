...
export default function Create() {
    ...
    return (
        <AppLayout>
            <Head title="Create Policy Type" />

            <div className="space-y-6">
                {/* Header */}
                <div className="mb-8">
                    <div className="mt-4">
                        <h1 className="text-3xl font-bold tracking-tight">Create Policy Type</h1>
                        <p className="text-muted-foreground">Create a new insurance policy type with custom configuration.</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="flex justify-end space-x-4">
                        ...
                        <Button type="submit" disabled={processing}>
                            {processing ? 'Creating...' : 'Create Policy Type'}
                        </Button>
                    </div>
                </form>
            </div>
