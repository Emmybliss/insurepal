                ...
                <div className="mb-8">
                    <div className="mt-4">
                        <div className="flex items-center gap-3">
                            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">{policyClass.name}</h1>
                            <Badge variant={policyClass.is_active ? 'default' : 'secondary'}>{policyClass.is_active ? 'Active' : 'Inactive'}</Badge>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            <div>
                                ...
                                <dd className="mt-1">
                                    <code className="rounded bg-gray-100 px-2 py-1 text-sm dark:bg-gray-700">{policyClass.code}</code>
                                </dd>
                            </div>
