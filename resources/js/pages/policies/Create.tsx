...
export default function Create({ policyTypes, policyClasses }: Props) {
    const { data, setData, post, processing, errors } = useForm<PolicyFormData>({
        policy_type_id: '',
        policy_class_id: '',
        name: '',
        code: '',
        ...
        base_premium: '',
        commission_rate: '',
        premium_factors: [] as PremiumFactor[],
        coverage_details: [] as CoverageDetail[],
        ...
        try {
            ...
            if (policyClass?.calculated_premium) {
                ...
                if (!data.base_premium) {
                    setData('base_premium', policyClass.calculated_premium.toString());
                }
            }
        } catch (error) {
    ...
    useEffect(() => {
        if (data.policy_type_id) {
            ...
            if (data.policy_class_id && !filtered.some((cls) => cls.id.toString() === data.policy_class_id.toString())) {
                setData((prev) => ({ ...prev, policy_class_id: '' }));
            }
        } else {
    ...
    return (
        <AppLayout>
            ...
            <div className="space-y-6">
                <div className="mb-8">
                    <div className="mt-4">
                        <h1 className="text-3xl font-bold tracking-tight">Create Policy Policy Product</h1>
                        <p className="text-muted-foreground">Create a complete insurance policy product for your organization.</p>
                    </div>
                </div>
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-4">
                                <div>
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => setData('base_premium', e.target.value)}
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                ...
                                <div>
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => setData('max_sum_assured', e.target.value)}
