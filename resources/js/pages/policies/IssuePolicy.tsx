                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <div className="relative flex-1">
                                            ...
                                            <Input
                                                ...
                                                disabled
                                                className="cursor-not-allowed bg-muted pl-10 text-muted-foreground"
                                            />
                                        </div>
                                    ...
                                    <p className="text-xs text-muted-foreground">Policy number is automatically generated when you save</p>
                                </div>
