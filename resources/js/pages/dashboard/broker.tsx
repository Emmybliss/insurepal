                ...
                <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                    ...
                    >
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted">{t('Total policy commissions')}</p>
                        </CardContent>
                    </Card>
                    ...
                    >
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted">{t('All issued policies')}</p>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        <CardHeader>
                            <div className="flex items-center justify-between">
                                ...
                                <Link href={'/policies?filter=expiring'}>
                                ...
                                {expiring_policies.length > 0 ? (
                                    expiring_policies.map((policy) => (
                                        ...
                                        >
                                            ...
                                            <Link href={`/policy-management/${policy.id}`}>
                                                <Button variant="outline" size="sm">
                        ...
                        <CardHeader>
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <CardDescription>Latest quotes requiring attention</CardDescription>
                                </div>
