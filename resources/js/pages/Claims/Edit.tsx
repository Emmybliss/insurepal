...
import { Claim, ClaimType, DocumentType } from '@/types/claim';
...
export default function Edit({ claim, policies, claimTypes, documentTypes }: Props) {
    ...
    const handleSubmit: FormEventHandler = (e) => {
        ...
        put(route('claims.update', claim.id), {
            forceFormData: true,
    ...
    return (
        <AppLayout>
            <Head title={`Edit Claim - ${claim.claim_reference}`} />
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold">Edit Claim</h1>
                        <p className="text-muted-foreground">Update details for {claim.claim_reference}</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Update details for the insurance claim</CardDescription>
                        </CardHeader>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Upload photos, reports, or other supporting documents</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <p className="text-sm text-muted-foreground">Accepted: PDF, JPG, PNG, DOC, DOCX (Max 10MB)</p>
                                </div>
                            </div>
