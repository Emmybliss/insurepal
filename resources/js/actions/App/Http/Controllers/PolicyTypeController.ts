...
show.url = (args: { policy_type: string | number } | [policy_type: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return show.definition.url.replace('{policy_type}', parsedArgs.policy_type.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
edit.url = (args: { policy_type: string | number } | [policy_type: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return edit.definition.url.replace('{policy_type}', parsedArgs.policy_type.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
update.url = (args: { policy_type: string | number } | [policy_type: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return update.definition.url.replace('{policy_type}', parsedArgs.policy_type.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
destroy.url = (args: { policy_type: string | number } | [policy_type: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return destroy.definition.url.replace('{policy_type}', parsedArgs.policy_type.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
toggleStatus.url = (args: { policy_type: string | number } | [policy_type: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return toggleStatus.definition.url.replace('{policy_type}', parsedArgs.policy_type.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
const PolicyTypeController = { index, create, store, show, edit, update, destroy, toggleStatus };
