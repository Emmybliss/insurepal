 ...
 */
export const show = (
    args: { policy_class: string | number } | [policy_class: string | number] | string | number,
...
show.url = (args: { policy_class: string | number } | [policy_class: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return show.definition.url.replace('{policy_class}', parsedArgs.policy_class.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
edit.url = (args: { policy_class: string | number } | [policy_class: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return edit.definition.url.replace('{policy_class}', parsedArgs.policy_class.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
update.url = (args: { policy_class: string | number } | [policy_class: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return update.definition.url.replace('{policy_class}', parsedArgs.policy_class.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
destroy.url = (args: { policy_class: string | number } | [policy_class: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return destroy.definition.url.replace('{policy_class}', parsedArgs.policy_class.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
toggleStatus.url = (args: { policy_class: string | number } | [policy_class: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return toggleStatus.definition.url.replace('{policy_class}', parsedArgs.policy_class.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
getByCategory.url = (
    ...
    return (
        getByCategory.definition.url.replace('{policy_category}', parsedArgs.policy_category.toString()).replace(/\/+$/, '') + queryParams(options)
    );
};
