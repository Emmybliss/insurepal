...
/**
* @see \App\Http\Controllers\PolicyClassController::getByCategory
 * @see app/Http/Controllers/PolicyClassController.php:123
 * @route '/admin/api/policy-categories/{policy_category}/classes'
 */
export const getByCategory = (args: { policy_category: string | number } | [policy_category: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
 ...
 * @route '/admin/api/policy-categories/{policy_category}/classes'
 */
getByCategory.url = (args: { policy_category: string | number } | [policy_category: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
 ...
 * @route '/admin/api/policy-categories/{policy_category}/classes'
 */
getByCategory.get = (args: { policy_category: string | number } | [policy_category: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: getByCategory.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/admin/api/policy-categories/{policy_category}/classes'
 */
getByCategory.head = (args: { policy_category: string | number } | [policy_category: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: getByCategory.url(args, options),
    method: 'head',
})
 ...
 * @route '/admin/api/policy-categories/{policy_category}/classes'
 */
    const getByCategoryForm = (args: { policy_category: string | number } | [policy_category: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/admin/api/policy-categories/{policy_category}/classes'
 */
        getByCategoryForm.get = (args: { policy_category: string | number } | [policy_category: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: getByCategory.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/admin/api/policy-categories/{policy_category}/classes'
 */
        getByCategoryForm.head = (args: { policy_category: string | number } | [policy_category: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
const PolicyClassController = { index, create, store, show, edit, update, destroy, toggleStatus, getByCategory }

export default PolicyClassController