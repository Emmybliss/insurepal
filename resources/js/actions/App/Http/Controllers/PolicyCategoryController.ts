 ...
 */
export const show = (
    args: { policy_category: string | number } | [policy_category: string | number] | string | number,
...
show.url = (args: { policy_category: string | number } | [policy_category: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return show.definition.url.replace('{policy_category}', parsedArgs.policy_category.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
edit.url = (args: { policy_category: string | number } | [policy_category: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return edit.definition.url.replace('{policy_category}', parsedArgs.policy_category.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
update.url = (args: { policy_category: string | number } | [policy_category: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return update.definition.url.replace('{policy_category}', parsedArgs.policy_category.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
destroy.url = (args: { policy_category: string | number } | [policy_category: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return destroy.definition.url.replace('{policy_category}', parsedArgs.policy_category.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
toggleStatus.url = (
    ...
    return toggleStatus.definition.url.replace('{policy_category}', parsedArgs.policy_category.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
export const getByType = (
    args: { policy_type: string | number } | [policy_type: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
...
getByType.url = (args: { policy_type: string | number } | [policy_type: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return getByType.definition.url.replace('{policy_type}', parsedArgs.policy_type.toString()).replace(/\/+$/, '') + queryParams(options);
};
