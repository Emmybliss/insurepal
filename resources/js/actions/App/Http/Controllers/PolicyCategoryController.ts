...
/**
* @see \App\Http\Controllers\PolicyCategoryController::getByType
 * @see app/Http/Controllers/PolicyCategoryController.php:112
 * @route '/admin/api/policy-types/{policy_type}/categories'
 */
export const getByType = (args: { policy_type: string | number } | [policy_type: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: getByType.url(args, options),
    method: 'get',
})

getByType.definition = {
    methods: ["get","head"],
 ...
 * @route '/admin/api/policy-types/{policy_type}/categories'
 */
getByType.url = (args: { policy_type: string | number } | [policy_type: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
    ...
    return getByType.definition.url
 ...
 * @route '/admin/api/policy-types/{policy_type}/categories'
 */
getByType.get = (args: { policy_type: string | number } | [policy_type: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: getByType.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/admin/api/policy-types/{policy_type}/categories'
 */
getByType.head = (args: { policy_type: string | number } | [policy_type: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: getByType.url(args, options),
    method: 'head',
})
 ...
 * @route '/admin/api/policy-types/{policy_type}/categories'
 */
    const getByTypeForm = (args: { policy_type: string | number } | [policy_type: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: getByType.url(args, options),
        method: 'get',
    })
 ...
 * @route '/admin/api/policy-types/{policy_type}/categories'
 */
        getByTypeForm.get = (args: { policy_type: string | number } | [policy_type: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: getByType.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/admin/api/policy-types/{policy_type}/categories'
 */
        getByTypeForm.head = (args: { policy_type: string | number } | [policy_type: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: getByType.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
    ...
    getByType.form = getByTypeForm
const PolicyCategoryController = { index, create, store, show, edit, update, destroy, toggleStatus, getByType }

export default PolicyCategoryController