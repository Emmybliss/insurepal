@if(!empty($branding['footer_image_path']))
    <img src="{{ $branding['footer_image_path'] }}" alt="Footer Image" style="width: 100%; height: 100%; object-fit: contain; object-position: center; display: block;">
@elseif(!empty($branding['footer_image_base64']))
    <img src="{{ $branding['footer_image_base64'] }}" alt="Footer Image" style="width: 100%; height: 100%; object-fit: contain; object-position: center; display: block;">
@else
