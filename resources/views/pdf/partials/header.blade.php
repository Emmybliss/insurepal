@if(!empty($branding['header_image_path']))
    <img src="{{ $branding['header_image_path'] }}" alt="Header Image" style="width: 100%; height: 100%; object-fit: contain; object-position: center; display: block;">
@elseif(!empty($branding['header_image_base64']))
    <img src="{{ $branding['header_image_base64'] }}" alt="Header Image" style="width: 100%; height: 100%; object-fit: contain; object-position: center; display: block;">
@else
