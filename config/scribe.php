...
return [
    ...
    'routes' => [
        [
            ...
            'include' => [],
            'exclude' => [
                'api/v1/payments/webhook/*', // Exclude webhooks from public API docs
            ],
        ],
    ],
    ...
    'auth' => [
        ...
        'in' => 'header',
        'name' => 'X-API-KEY',
        'use_value' => env('SCRIBE_AUTH_KEY', 'sk_test_demo_key'),
        'placeholder' => 'sk_live_...',
        'extra_info' => 'You can retrieve your API key from your **Tenant Dashboard > Settings > API Settings**.',
    ],
